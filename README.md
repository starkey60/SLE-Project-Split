# Software Language Engineering project DELTA

Runinng the pipeline:
1. write your delta file (or use one of the provided test files)
...
2. import DSL_LSP;
3. run register();
4. check open up `examples/warning_error_test.delta` to check for errors and warnings showing. You may need to refresh (delete a character and save)
